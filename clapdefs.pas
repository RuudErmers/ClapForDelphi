...
const
  ...
  CLAP_VERSION_INIT: Tclap_version = (
...
type TClapString = array[0..CLAP_NAME_SIZE-1] of byte; // for function parameters you need a type
...
type
  Tclap_event_header = record
    ...
    _type: uint16_t;     // event type , changed by RE
...
type
  ...
  Pclap_host_timer_support=^Tclap_host_timer_support;
...
type
  Tclap_audio_port_info = record
    ...
    id: Tclap_id;
    name: TClapString;//array[0..CLAP_NAME_SIZE - 1] of byte; // displayable name
...
type
  Tclap_note_port_info = record
    ...
    name: TClapString; //array[0..CLAP_NAME_SIZE - 1] of byte; // displayable name, i18n?
  end;
...
(*added by RE *)
type  Pclap_event_note= ^Tclap_event_note;
      Pclap_event_param_value=^Tclap_event_param_value;
      Pclap_event_midi = ^Tclap_event_midi;
      Pclap_event_midi_sysex = ^Tclap_event_midi_sysex;
      Pclap_audio_buffer = ^Tclap_audio_buffer;
